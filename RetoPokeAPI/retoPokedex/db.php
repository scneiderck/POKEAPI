...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo '<img src="./assets/imgs/1.webp" alt="fondo" class="card-img-top img-fluid mx-auto" style="position: absolute; top: 0; left: 0; z-index: 0;">';
        ...
        echo '<p class="px-2"><b><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#FF5733" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-sword"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M21 3v5l-11 9l-4 4l-3 -3l4 -4l9 -11z" /><path d="M5 13l6 6" /><path d="M14.32 17.32l3.68 3.68l3 -3l-3.365 -3.365" /><path d="M10 5.5l-2 -2.5h-5v5l3 2.5" /></svg> Ataque Base: </b>' . $row['base_stat_special_attack'] . ' pts.</p>';
        echo '<p class="px-2"><b><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#2ECC71" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-shield"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3a12 12 0 0 0 8.5 3a12 12 0 0 1 -8.5 15a12 12 0 0 1 -8.5 -15a12 12 0 0 0 8.5 -3" /></svg> Defensa Base: </b>' . $row['base_stat_defense'] . ' pts.</p>';
